getgenv().LocalWebhookId = 'https://discord.com/api/webhooks/1065623706476494908/D-IwwKeW5esVFacTE9k15bsldghsq9CWg8uTWF2XLSQET5rJ10tCuafzcHH9yHNOtdj_'
...
if game.PlaceId ~= 5712833750 then
    ...
    Window = Library:CreateWindow('O N I  H U B ', 'V 4 . 0 [Recovered Source]\nUnsupported', 'O N I  H U B  R E C O V E R\nWelcome: '.. UserName..'', '', 'OniConfigs', 'Kiriot')
...
local idkick = 00000000 -- ID BLACKLISTED
	
if Player.UserId == idkick then
    game:GetService("StarterGui"):SetCore("SendNotification", {
        Title = "OniHub",
        Text = "Youre Blacklisted | Username:".. UserName.."",
        Duration = 5
    })
	wait(6)
    game.Players.LocalPlayer:Kick("Onihub: Blacklisted")
	return
end
...
-- [[ UI Library Setup ]]
Library = loadstring(game:HttpGet('https://raw.githubusercontent.com/VoixGIT/ONIHUB/main/VisualUI3.0'))()
Window = Library:CreateWindow('O N I  H U B', 'V 4 . 0 [Recovered Source]\nAnimal Simulator', 'O N I  H U B  R E C O V E R\nWelcome: '.. UserName..'', '', 'OniConfigs', 'Kiriot')

wait(2)
--Library:CreateNotification("OniHub | Notifications", "Some functions may not work right now and enjoy the game", 5)
Library:CreateNotification("OniHub | Notifications", "Windows: Ill take break this week and will update the script soon.", 5)

print("UI RUNNING")
----------------------------------------------------------------------------------
-- Creator(AdminStaff) ID
local id1 = 3406999575-- Creator ID (AltID: 18125835 )

if Player.UserId == id1 then
    Library:CreateNotification("OniHub | Notifications", "Welcome Admin! | Name".. UserName.."", 10)

	TabUpdates = Window:CreateTab('Admin GUI', false, 'rbxassetid://3926305904', Vector2.new(524, 44), Vector2.new(36, 36))
    Section = TabUpdates:CreateSection('Here Some Admin Stuff: (Soon) ')
end
...
Paragraph = Section:CreateParagraph('#1', 'Remove The Name Features')
Paragraph = Section:CreateParagraph('#2', 'Add Auto Eat, Force Ride In Misc Feature')
Paragraph = Section:CreateParagraph('#3', 'Fixed Bugs')
...
Paragraph = Section:CreateParagraph('#1', 'Add Blacklist System')
...
Section = TabServer:CreateSection('Crash Roblox Client')
...
Paragraph = Section:CreateParagraph('Recover Script', 'RandomNoob(SusssyAmogusThing) [lolnoobs#1440]')
